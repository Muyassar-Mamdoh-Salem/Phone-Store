...
const ContactUs = () => {
  ...
  return (
    <div className='bg-[#b1ebe5] pb-5' id='ContactUs'>
        ...
        <div>
          <form className='grid gap-4 grid-cols-2' ref={form} onSubmit={sendEmail}>
            ...
            <div className="flex flex-col">
              <label>Name:</label>
              <input className='border-2 border-blue-200 py-2 rounded-full px-4' name="user_name" type="text" required />
            </div>

            {/* Phone */}
            <div className="flex flex-col">
              <label>Phone:</label>
              <input type="tel" className='border-2 border-blue-200 py-2 rounded-full px-4' name="phone" />
            </div>

            {/* Email */}
            <div className="flex flex-col">
              <label>Email:</label>
              <input type="email" className='border-2 border-blue-200 py-2 rounded-full px-4' name="email" required />
            </div>

            {/* Message */}
            <div className="flex flex-col col-span-2">
              <label>Message:</label>
              <textarea className='border-2 border-blue-200 py-2 px-4 rounded-xl min-h-[120px]' name="message" required />
            </div>
