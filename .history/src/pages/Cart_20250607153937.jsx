      ...
      {cart.length === 0 ? (
        ...
        <>
          ...
          <div className="mt-8 flex flex-col md:flex-row items-center justify-between gap-4">
            ...
            <button className=''>go to checkout</button> <button className="border rounded-lg px-4 py-2 bg-green-500 text-white hover:bg-green-600 transition duration-300 w-full sm:w-auto">
                Buy Now
              </button>
          </div>
        </>
