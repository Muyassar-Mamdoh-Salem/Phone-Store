...
const scrollToFooter = () => {
 const ContactUs = document.getElementById("Footer");
  if (!ContactUs) return;

  const start = window.scrollY;
  const end = ContactUs.getBoundingClientRect().top + window.scrollY;
        ...
        <ul className="flex justify-between items-center list-none font-semibold p-0 m-0">
          <div className="flex gap-8">
            <li>
              ...
              <HashLink className='hover:underline hover:text-[#FFB433] transition-colors' smooth
  to="/#top">
            ...
            <li>
            <HashLink to={"#ContactUs"}  className="hover:underline hover:text-[#FFB433] transition-colors bg-transparent border-none cursor-pointer">
contact
            </HashLink>
            </li>
          </div>
