...
import { uniqueItemCount } from '..//assets/context/AuthContext';
function NavbarMain() {
  ...
  const scrollToSection = (id) => {
    ...
    const navbarHeight = 70; // عدل هذا الرقم ليطابق ارتفاع الـ navbar الخاص بك
