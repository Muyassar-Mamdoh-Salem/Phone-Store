...
<ul className='flex gap-4 text-2xl'>
    <Link className='text-2xl text-[#FA8912]'><FaTwitter /></Link>
    <Link className=''><FaFacebookF className='text-2xl text-[#FA8912]' /></Link>
    <Link ><FaTiktok className='text-2xl text-[#FA8912]' /></Link>
</ul>
    </div>
