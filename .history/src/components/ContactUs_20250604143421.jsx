...
const ContactForm = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs.sendForm(
      'service_ry2gq67', // ← استبدله
      'template_tqax8p9', // ← استبدله
      form.current,
      'sT-JJYsulZ724TlJj' // ← استبدله
    )
    .then((result) => {
                ...
                <div>
                    <form className='grid gap-4 grid-cols-2' ref={form} onSubmit={sendEmail}>
                        ...
                        <div className="flex flex-col">
                            <label>Name:</label>
                            <input type="text" className='border-2 border-blue-200 py-2 rounded-full px-4' name="user_name" type="text" />
                        </div>

                        {/* Phone */}
                        <div className="flex flex-col">
                            <label>Phone:</label>
                            <input type="phone" className='border-2 border-blue-200 py-2 rounded-full px-4'  name="phone"/>
                        </div>

                        {/* Email */}
                        <div className="flex flex-col">
                            <label>Email:</label>
                            <input type="email" className='border-2 border-blue-200 py-2 rounded-full px-4' name="email"/>
                        </div>
