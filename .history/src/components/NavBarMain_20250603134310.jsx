      ...
      <div className="hidden lg:block">
        <ul className="flex justify-between items-center list-none font-semibold p-0 m-0">
          <div className="flex gap-8">
            ...
            <li>
             <HashLink className=' onClick={() => handleSectionScroll('about')}
                className="hover:underline hover:text-[#FFB433] transition-colors bg-transparent border-none cursor-pointer"></li>
             </HashLink>
            </li>
            <li>
              <button
